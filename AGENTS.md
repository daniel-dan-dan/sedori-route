...
- GET: `getStores`, `getConfig`, `getRouteHistory`, `getRouteCorrectionSuggestions`, `getPurchases`, `getMemos`, `getFinds`, `getInventoryPurchases`, `recalcPriorityScores`, `updateRouteDate`
